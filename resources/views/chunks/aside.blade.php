<aside class="main-sidebar col-md-3 card-body" id="main-aside">
    ...
    <nav id="sidebar">
        <ul class="list-unstyled components">
            ...
            <hr class="mb-1">
            <li class="aside-slave py-1" data-for-route="{{ route('demo') }}">
                <a href="{{ route('demo') }}">
            ...
            <li class="aside-slave py-1" data-for-route="{{ route('start') }}">
                <a href="{{ route('start') }}">
            ...
            <li class="aside-slave py-1" data-for-route="{{ route('profi') }}">
                <a href="{{ route('profi') }}">
            ...
            <li class="aside-slave py-1" data-for-route="{{ route('helpme') }}">
                <a href="{{ route('helpme') }}">
            ...
            <li class="aside-slave py-1" data-for-route="{{ route('vip') }}">
                <a href="{{ route('vip') }}">
            ...
            <hr class="mb-1">
            <li class="aside-slave py-1" data-for-route="{{ route('gallery') }}">
            ...
            <li class="aside-slave py-1" data-for-route="{{ route('profile') }}">
